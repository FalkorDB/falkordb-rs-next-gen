...
class testQueryValidationFlow(FlowTestsBase):
    ...
    def test26_invalid_filter_predicate(self):
        queries = [
            ...
            # Pattern comprehension with anonymous pattern - parser doesn't support this yet @todo barak
    ...
    def test28_invalid_filter_binary_not(self):
        try:
            ...
            # Expecting an error.
            assert("Invalid usage of 'NOT' filter" in str(e) or "Invalid input 'NOT'" in str(e))
            pass
