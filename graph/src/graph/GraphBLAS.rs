...
// bindgen --default-enum-style=rust --allowlist-file /usr/local/include/suitesparse/GraphBLAS.h /usr/local/include/suitesparse/GraphBLAS.h -o graph/src/GraphBLAS.rs
#![allow(unused)]
