...
// bindgen --allowlist-file /usr/local/include/suitesparse/GraphBLAS.h /usr/local/include/suitesparse/GraphBLAS.h -o graph/src/GraphBLAS.rs
#![allow(unused)]
...
pub const GxB_IMPLEMENTATION_DATE: &[u8; 12] = b"Mar 3, 2025\0";
