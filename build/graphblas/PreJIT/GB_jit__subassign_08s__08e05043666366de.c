//------------------------------------------------------------------------------
// GB_jit__subassign_08s__08e05043666366de.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08s__08e05043666366de
#define GB_jit_query  GB_jit__subassign_08s__08e05043666366de_query
#endif
#include "template/GB_jit_kernel_subassign_08s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x9a06b15de695971f ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
